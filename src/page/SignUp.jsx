...
export default function SignUn() {
  ...
  return (
    <section>
     <h1 className="text-3xl text-center mt-6 font-bold"> SignUn</h1>
     ...
     <div className="w-full md:w-[60%] lg:w-[40%] ml-20">
        <form>
        <input type="text" id="text" value={Text} onChange={onChange} placeholder="Full Name"
        ...
        <p className="mb-6">
             Have a account?
            <Link to="/sign-in" className="text-red-600 hover:text-red-400 transition duration-200 ease-in-out ml-1">SignIn</Link>
        </p>
        <p>
        ...
        <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-800 transition duration-150 ease-in-out active:bg-blue-900" type="submit">Sign up</button>
