  ...
  return (
    <section>
     ...
     <div className="w-full md:w-[60%] lg:w-[40%] ml-20">
        ...
        <p>
            <Link to="/Sign-in" className="hover:text-blue-400 text-red-800 transition duration-200 ease-in-out">Back o sign-in</Link>
        </p>
        </div>

        <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-800 transition duration-150 ease-in-out active:bg-blue-900" type="submit">send reset password</button>
